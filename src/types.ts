...
export interface AutoConfig {
    ...
    staLyfe3Pool?: { id: string; address: string };
...
export interface SubgraphPoolBase {
    ...
    // Multi2 specific fields
    sqrtAlpha?: string;
    sqrtBeta?: string;

    // Multi3 specific field
    root3Alpha?: string;

    // MultiE specific fields
    alpha?: string;
    beta?: string;
    c?: string;
    s?: string;
...
export interface TokenPriceService {
     ...
     * Example: LYFE = $20 USD, ETH = $4,000 USD, then 1 ETH = 200 LYFE. This function would return 200.
     * @param tokenAddress
     */
