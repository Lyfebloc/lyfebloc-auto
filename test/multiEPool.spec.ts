// TS_NODE_PROJECT='tsconfig.testing.json' npx mocha -r ts-node/register test/multiEPool.spec.ts

import { MultiEPoolPairData } from '../src/pools/multiEPool/multiEPool';
import { WeiPerEther as ONE } from '@ethersproject/constants';
import { formatFixed, parseFixed } from '@ethersproject/bignumber';
import { expect } from 'chai';
import { MultiEPool } from '../src/pools/multiEPool/multiEPool';
import { SwapTypes } from '../src/types';
import { bnum } from '../src/utils/bignumber';
import { reduceFee } from '../src/pools/multiEPool/multiEMath/multiEMathHelpers';
...
const POOL = MultiEPool.fromPool({
    id: '1',
    address: '1',
    poolType: 'MultiE',
    swapFee: '0.09',
