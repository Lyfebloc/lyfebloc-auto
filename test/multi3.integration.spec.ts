// TS_NODE_PROJECT='tsconfig.testing.json' npx mocha -r ts-node/register test/multi3.integration.spec.ts
...
const multi3Pool: SubgraphPoolBase = {
...
describe('multi3 integration tests', () => {
