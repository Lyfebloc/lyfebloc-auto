// TS_NODE_PROJECT='tsconfig.testing.json' npx mocha -r ts-node/register test/multi2.integration.spec.ts
...
const reserve = Reserve__factory.connect(reserveAddr, provider);

const multi2Pool: SubgraphPoolBase = {
...
describe('multi2 integration tests', () => {
    context('test swaps vs queryBatchSwap', () => {
        ...
        it('ExactIn', async () => {
            ...
            const queryResult = await reserve.callStatic.queryBatchSwap(
                swapType,
                swapInfo.swaps,
