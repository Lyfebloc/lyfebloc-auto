...
export const AUTO_CONFIG: Record<Network, AutoConfig> = {
    [Network.MAINNET]: {
        chainId: Network.MAINNET, //1
        reserve: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
    ...
    [Network.GOERLI]: {
        ...
        reserve: '0x65748E8287Ce4B9E6D83EE853431958851550311',
    ...
    [Network.POLYGON]: {
        ...
        connectingTokens: [
            ...
            }, // Joins Stables<>BRZ via https://app.Lyfebloc.fi/#/polygon/pool/0x4a0b73f0d13ff6d43e304a174697e3d5cfd310a400020000000000000000091c
        ],
    },
    [Network.ARBITRUM]: {
...
export const SUBGRAPH_URLS = {
    [Network.MAINNET]:
        'https://api.thegraph.com/subgraphs/name/Lyfebloc/Lyfebloc-v2-beta',
    [Network.GOERLI]:
        'https://api.thegraph.com/subgraphs/name/Lyfebloc/Lyfebloc-goerli-v2',
    [Network.KOVAN]:
        'https://api.thegraph.com/subgraphs/name/Lyfebloc/Lyfebloc-kovan-v2',
    [Network.POLYGON]:
        'https://api.thegraph.com/subgraphs/name/Lyfebloc/Lyfebloc-polygon-v2',
    [Network.ARBITRUM]: `https://api.thegraph.com/subgraphs/name/Lyfebloc/Lyfebloc-arbitrum-v2`,
};

// This is the same across networks
export const reserveAddr = '0xBA12222222228d8Ba445958a75a0704d566BF2C8';
...
export const ADDRESSES = {
    ...
    [Network.KOVAN]: {
        // Visit https://Lyfebloc-faucet.on.fleek.co/#/faucet for test tokens
        BatchRelayer: {
