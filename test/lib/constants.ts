...
export const autoConfigTest: AutoConfig = {
    chainId: 99,
...
export const autoConfigTestStaLyfe = {
    chainId: 99,
    weth: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
    reserve: '0xeefba1e63905ef1d7acba5a8513c70307c1ce441',
    connectingTokens: [
...
export const autoConfigEth: AutoConfig = {
    chainId: 1,
    weth: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
    connectingTokens: [
        {
...
export const autoConfigKovan: AutoConfig = {
    chainId: 42,
...
export const autoConfigFullKovan: AutoConfig = {
    chainId: 42,
    weth: '0xdFCeA9088c8A88A76FF74892C1457C17dfeef9C1',
    connectingTokens: [
        {
...
export const lUSDC: TestToken = {
    address: '0x0000000000000000000000000000000000000001',
    decimals: 18,
};
export const LYFE: TestToken = {
...
export const lDAI: TestToken = {
    address: '0x0000000000000000000000000000000000000002',
    decimals: 18,
};
export const staLYFE3: TestToken = {
    address: '0x06df3b2bbb68adc8b0e302443692037ed9f91b42',
    decimals: 18,
};
...
export const KOVAN_LYFE: TestToken = {
