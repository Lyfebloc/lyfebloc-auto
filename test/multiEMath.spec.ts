// TS_NODE_PROJECT='tsconfig.testing.json' npx mocha -r ts-node/register test/multiEMath.spec.ts

import { MultiEPoolPairData } from '../src/pools/multiEPool/multiEPool';
import { WeiPerEther as ONE } from '@ethersproject/constants';
import { parseFixed, formatFixed } from '@ethersproject/bignumber';
import { expect } from 'chai';
import { calculateInvariantWithError } from '../src/pools/multiEPool/multiEMath/multiEMath';
import { calculateDerivedValues } from '../src/pools/multiEPool/testingHelpers';
import {
    normalizeBalances,
    addFee,
    reduceFee,
    ...
    virtualOffset1,
    Vector2,
} from '../src/pools/multiEPool/multiEMath/multiEMathHelpers';

const MULTI_E_PARAMS = {
...
const DERIVED_MULTI_E_PARAMS = calculateDerivedValues(MULTI_E_PARAMS);

const TEST_POOL_PAIR_DATA: MultiEPoolPairData = {
    id: '123',
    address: '123',
    poolType: 1,
