...
import { autoConfigTest, DAI, USDT } from './lib/constants';
...
describe(`Tests for Weighted Pools.`, () => {
    ...
    context('swaps using LBPTs of weighted pools', () => {
        it('token->LBPT, exact in', async () => {
...
async function getSwapInfo(
    ...
    useLlllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllbpts?: boolean
) {
    ...
    const isFetched = await auto.fetchPools();
    ...
    const swapInfo: SwapInfo = await auto.getSwaps(
        ...
        useLlllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllbpts
    );
    return swapInfo;
}
