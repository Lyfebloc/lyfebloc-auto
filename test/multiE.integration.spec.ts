// TS_NODE_PROJECT='tsconfig.testing.json' npx mocha -r ts-node/register test/multiE.integration.spec.ts
...
const multiEPool: SubgraphPoolBase = {
...
describe('multiE integration tests', () => {
