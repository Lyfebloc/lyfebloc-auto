...
describe('Tests full swaps against known values', () => {
    ...
    it('Full Multihop AUTO, USDC>yUSD, swapExactIn', async () => {
        const allPools =
            subgraphPoolsDecimalsTest.pools as unknown as SubgraphPoolBase[];
    ...
    it('Full Multihop AUTO,  WBTC>MKR2, swapExactOut', async () => {
        const allPools =
            subgraphPoolsDecimalsTest.pools as unknown as SubgraphPoolBase[];
    ...
    it('Full Multihop AUTO, USDC>yUSD, swapExactOut', async () => {
        const allPools =
            subgraphPoolsDecimalsTest.pools as unknown as SubgraphPoolBase[];
    ...
    it('Test for swap with 2 decimal token - route available', async () => {
        ...
        After fix the AUTO should consider an alternative viable route with swap amount > 0.
        */
